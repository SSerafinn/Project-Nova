...
export function ArrowsRightLeftIcon({ className = 'w-5 h-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor">
...
export function StarIcon({ className = 'w-6 h-6', filled = false }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} strokeWidth={1.75} stroke="currentColor">
...
export function CloudArrowUpIcon({ className = 'w-8 h-8' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
